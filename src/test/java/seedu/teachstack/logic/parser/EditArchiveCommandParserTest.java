...
public class EditArchiveCommandParserTest {

    private static final String GROUP_EMPTY = " " + PREFIX_GROUP;

    private static final String MESSAGE_INVALID_FORMAT =
            String.format(MESSAGE_INVALID_COMMAND_FORMAT, EditArchiveCommand.MESSAGE_USAGE);

    private EditArchiveCommandParser parser = new EditArchiveCommandParser();
    ...
    public void parse_missingParts_failure() {
        ...
        // no field specified
        assertParseFailure(parser, "A1234567A", EditArchiveCommand.MESSAGE_NOT_EDITED);
    ...
    public void parse_allFieldsSpecified_success() {
        ...
        EditArchiveCommand expectedCommand = new EditArchiveCommand(targetId, descriptor);
    ...
    public void parse_oneFieldSpecified_success() {
        ...
        expectedCommand = new EditArchiveCommand(targetId, descriptor);
        assertParseSuccess(parser, userInput, expectedCommand);
