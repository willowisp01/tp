...
/**
 * Parses input arguments and creates a new EditArchiveCommand object
 */
public class EditArchiveCommandParser implements Parser<EditArchiveCommand> {

    /**
     * Parses the given {@code String} of arguments in the context of the EditArchiveCommand
     * and returns an EditArchiveCommand object for execution.
     * @throws ParseException if the user input does not conform the expected format
     */
    public EditArchiveCommand parse(String args) throws ParseException {
        requireNonNull(args);
        ...
        if (!editPersonDescriptor.isAnyFieldEdited()) {
            throw new ParseException(EditArchiveCommand.MESSAGE_NOT_EDITED);
        }

        return new EditArchiveCommand(id, editPersonDescriptor);
    }
